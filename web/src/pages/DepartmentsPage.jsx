		...
		<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm">
			<div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh]">
				...
				<form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4">
					...
					<div className="space-y-1">
						<label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Code (slug) *</label>
						<input
							type="text"
							name="code"
							required
					...
					<div className="space-y-1">
						<label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Color (Map Pin)</label>
					...
					<div className="flex items-center gap-3 pt-1">
						...
						/>
						<label htmlFor="dept-is-active" className="text-sm font-medium text-gray-700 cursor-pointer">
					...
					<div className="pt-4 flex justify-end gap-3">
						...
						<Button type="submit" disabled={isLoading}>
							{isLoading ? 'Saving...' : isEdit ? 'Save Changes' : 'Create College'}
						</Button>
					</div>
				</form>
			</div>
	...
	return (
		<div className="space-y-6">
			<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
				<div>
					<h1 className="text-2xl font-bold text-gray-900 mb-1">Colleges</h1>
					<p className="text-gray-500 text-sm">Group buildings by college to organize map pins and search results.</p>
				</div>
									...
									{paginatedDepartments.map((dept) => (
										...
										>
											<td className="px-6 py-4">
												<div className="flex items-center gap-3">
													<div
														...
														style={{ backgroundColor: dept.color_hex || '#96C0CE' }}
													/>
											...
											<td className="px-6 py-4">
												...
												<span className="text-xs text-gray-400 ml-1">buildings</span>
											</td>
											<td className="px-6 py-4">
												<Badge variant={dept.is_active ? 'success' : 'gray'}>
											...
											<td className="px-6 py-4 text-right">
												<div
													...
													ref={openMenu === dept.id ? menuRef : null}
												>
													<button
														onClick={() =>
															setOpenMenu(openMenu === dept.id ? null : dept.id)
														}
