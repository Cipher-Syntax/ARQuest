...
export default function CmsPage() {
    ...
    const handleSaveQuest = async () => {
        ...
        try {
            ...
            if (editingItem) {
                ...
                setQuests(
                    quests.map((q) => (q.id === updated.id ? updated : q)),
                );
            } else {
    ...
    const handleSaveTrivia = async () => {
        ...
        try {
            ...
            if (editingItem) {
                const updated = await triviaService.updateTrivia(
                    editingItem.id,
                    payload,
                );
                setTrivias(
                    trivias.map((t) => (t.id === updated.id ? updated : t)),
                );
            } else {
        ...
        <div className="space-y-6 pb-20">
            <div>
                ...
                <p className="text-gray-500 mt-1">
                    Select a building to manage its Quests and Trivia Facts.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {filteredBuildings.map((b) => {
                    const bQuests = quests.filter(
                        (q) =>
                            q.target_building === b.id ||
                            q.target_building_name === b.name,
                    );
                    const bTrivias = trivias.filter(
                        (t) =>
                            t.building === b.id || t.building_name === b.name,
                    );
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-start gap-3 mb-3">
                                ...
                                <h3 className="font-bold text-gray-900 line-clamp-2 leading-tight text-sm mt-1">
                                    {b.name}
                                </h3>
                            </div>
                            <div className="flex flex-wrap gap-1">
                                ...
                                <Badge
                                    variant={
                                        bQuizzes.length > 0 ? "blue" : "default"
                                    }
                                    className="text-[9px] py-0.5 px-1.5"
                                >
                            ...
                            {selectedBuilding.image_url ? (
                                ...
                                <div className="text-center z-10">
                                    ...
                                    <p className="text-white/30 text-sm mt-1">
                                        Upload a GLB file in the Buildings
                                        editor
                                    </p>
                                </div>
                            )}
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full p-2.5 border ${errors.title ? "border-red-500" : "border-gray-300"} rounded-md text-sm focus:ring-2 focus:ring-[#B21830]/20 focus:border-[#B21830] outline-none`}
                                                ...
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        className={`w-full p-2.5 border ${errors.hint ? "border-red-500" : "border-gray-300"} rounded-md text-sm h-24 focus:ring-2 focus:ring-[#B21830]/20 focus:border-[#B21830] outline-none`}
                                                        placeholder="e.g. Look behind the main staircase on the first floor..."
                                                    />
                                                    {errors.hint && (
                                                        <p className="text-red-500 text-xs mt-1">
                                                            {errors.hint}
                                                ...
                                                <div className="grid grid-cols-2 gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full p-2.5 border ${errors.reward_points ? "border-red-500" : "border-gray-300"} rounded-md text-sm focus:ring-2 focus:ring-[#B21830]/20 focus:border-[#B21830] outline-none`}
                                                        />
                                                ...
                                                <div className="flex justify-end pt-2">
                                                    <Button
                                                        ...
                                                        className="bg-[#B21830] hover:bg-[#8e1326] text-white"
                                                    >
                                                        Save Quest
                                                    </Button>
                                                </div>
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        className={`w-full p-2.5 border ${errors.fact ? "border-red-500" : "border-gray-300"} rounded-md text-sm h-32 focus:ring-2 focus:ring-[#B21830]/20 focus:border-[#B21830] outline-none`}
                                                        placeholder="e.g. This building was constructed in 1980..."
                                                    />
                                                    {errors.fact && (
                                                        <p className="text-red-500 text-xs mt-1">
                                                            {errors.fact}
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    ...
                                                    <textarea
                                                        ...
                                                        className={`w-full p-2.5 border ${errors.question ? "border-red-500" : "border-gray-300"} rounded-md text-sm h-20 focus:ring-2 focus:ring-[#B21830]/20 focus:border-[#B21830] outline-none resize-none`}
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full p-2 border ${errors.option_a ? "border-red-500" : "border-gray-300"} rounded-md text-sm`}
                                                        />
                                                        {errors.option_a && (
                                                            <p className="text-red-500 text-xs mt-1">
                                                                {
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full p-2 border ${errors.option_b ? "border-red-500" : "border-gray-300"} rounded-md text-sm`}
                                                        />
                                                        {errors.option_b && (
                                                            <p className="text-red-500 text-xs mt-1">
                                                                {
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full p-2 border ${errors.option_c ? "border-red-500" : "border-gray-300"} rounded-md text-sm`}
                                                        />
                                                        {errors.option_c && (
                                                            <p className="text-red-500 text-xs mt-1">
                                                                {
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full p-2 border ${errors.option_d ? "border-red-500" : "border-gray-300"} rounded-md text-sm`}
                                                        />
                                                        {errors.option_d && (
                                                            <p className="text-red-500 text-xs mt-1">
                                                                {
                                                ...
                                                <div className="flex gap-4">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <input
                                                            ...
                                                            className={`w-full p-2 border ${errors.exp_reward ? "border-red-500" : "border-gray-300"} rounded-md text-sm`}
                                                        />
                                                        {errors.exp_reward && (
                                                            <p className="text-red-500 text-xs mt-1">
                                                                {
                                    ...
                                    <>
                                        <div className="flex justify-end mb-6">
                                            <Button
                                                ...
                                                className="bg-[#B21830] hover:bg-[#8e1326] text-white shadow-sm border-none"
                                            >
                                                <Plus
                                                    size={16}
                                                    className="mr-1"
                                                ...
                                                quests
                                                    ...
                                                    .map((quest) => {
                                                        ...
                                                        return (
                                                            <div
                                                                key={quest.id}
                                                                className={`bg-white p-4 rounded-lg border-l-4 ${isExpired ? "border-gray-400 opacity-70" : "border-[#B21830]"} border-y border-r border-gray-200 shadow-sm flex items-start justify-between gap-4 group hover:border-y-[#B21830]/30 hover:border-r-[#B21830]/30 transition-all`}
                                                            >
                                                                <div className="flex gap-3">
                                                                    <div
                                                                        className={`mt-0.5 p-2 rounded-md shrink-0 ${isExpired ? "bg-gray-100 text-gray-400" : "bg-[#B21830]/10 text-[#B21830]"}`}
                                                                    >
                                                                        <Target
                                                                            size={
                                                                                20
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        <div className="flex items-center gap-2 mb-1">
                                                                            <h4
                                                                                className={`font-extrabold truncate ${isExpired ? "text-gray-500 line-through" : "text-gray-900"}`}
                                                                            >
                                                                                {
                                                                                    quest.title
                                                                                }
                                                                            ...
                                                                            <span
                                                                                className={`inline-block text-[10px] font-bold px-1.5 py-0.5 rounded-sm uppercase tracking-wider ${isExpired ? "bg-gray-100 text-gray-500" : "text-[#B21830] bg-[#B21830]/10"}`}
                                                                            >
                                                                                +
                                                                                {
                                                                                    quest.reward_points
                                                                ...
                                                                <div className="flex flex-col gap-1 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                                                                    <button
                                                                        ...
                                                                        className="p-1.5 text-gray-400 hover:text-[#B21830] bg-gray-50 hover:bg-[#B21830]/10 rounded-md transition-colors"
                                                                    >
                                                                        <Edit3
                                                                            size={
                                                                                14
                                            ...
                                            {activeTab === "trivias" &&
                                                trivias
                                                    ...
                                                    .map((trivia) => (
                                                        <div
                                                            key={trivia.id}
                                                            className="bg-white p-4 rounded-lg border-l-4 border-[#B21830] border-y border-r border-gray-200 shadow-sm flex items-start justify-between gap-4 group hover:border-y-[#B21830]/30 hover:border-r-[#B21830]/30 transition-all"
                                                        >
                                                            <div className="flex gap-3">
                                            ...
                                            {activeTab === "quizzes" &&
                                                quizzes
                                                    ...
                                                    .map((quiz) => (
                                                        <div
                                                            key={quiz.id}
                                                            className="bg-white p-4 rounded-lg border-l-4 border-[#B21830] border-y border-r border-gray-200 shadow-sm flex flex-col gap-3 group hover:border-y-[#B21830]/30 hover:border-r-[#B21830]/30 transition-all"
                                                        >
                                                            <div className="flex justify-between items-start">
                                                                <div className="flex gap-3">
                                                                    ...
                                                                    <div className="flex-1 min-w-0 pt-0.5">
                                                                        ...
                                                                        <span className="inline-block mt-1 text-[10px] font-bold text-[#B21830] bg-[#B21830]/10 px-1.5 py-0.5 rounded-sm uppercase tracking-wider">
                                                                            +
                                                                            {
                                                                                quiz.exp_reward
                                                                            }{" "}
                                                            ...
                                                            <div className="grid grid-cols-2 gap-2 text-xs">
                                                                <div
                                                                    className={`px-2 py-1.5 rounded border ${quiz.correct_option === "A" ? "bg-green-50 border-green-200 text-green-700 font-medium" : "bg-gray-50 border-gray-200 text-gray-600"}`}
                                                                >
                                                                    A:{" "}
                                                                    {
                                                                        quiz.option_a
                                                                ...
                                                                <div
                                                                    className={`px-2 py-1.5 rounded border ${quiz.correct_option === "B" ? "bg-green-50 border-green-200 text-green-700 font-medium" : "bg-gray-50 border-gray-200 text-gray-600"}`}
                                                                >
                                                                    B:{" "}
                                                                    {
                                                                        quiz.option_b
                                                                ...
                                                                <div
                                                                    className={`px-2 py-1.5 rounded border ${quiz.correct_option === "C" ? "bg-green-50 border-green-200 text-green-700 font-medium" : "bg-gray-50 border-gray-200 text-gray-600"}`}
                                                                >
                                                                    C:{" "}
                                                                    {
                                                                        quiz.option_c
                                                                ...
                                                                <div
                                                                    className={`px-2 py-1.5 rounded border ${quiz.correct_option === "D" ? "bg-green-50 border-green-200 text-green-700 font-medium" : "bg-gray-50 border-gray-200 text-gray-600"}`}
                                                                >
                                                                    D:{" "}
                                                                    {
                                                                        quiz.option_d
