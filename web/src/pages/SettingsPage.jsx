        ...
        <div className="space-y-5">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <Toggle
              ...
              onChange={() => handleChange('maintenance_mode', !settings.maintenance_mode)}
            />
          </div>
        </div>
      </Card>
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-start justify-between gap-4">
            ...
            <Toggle
              ...
              onChange={() => handleChange('enable_ar_selfie', !settings.enable_ar_selfie)}
            />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="flex items-start justify-between gap-4">
            ...
            <Toggle
              ...
              onChange={() => handleChange('enable_accreditation', !settings.enable_accreditation)}
            />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="flex items-start justify-between gap-4">
        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between gap-4">
            ...
            <Toggle
              ...
              onChange={() => handleChange('enable_leaderboard', !settings.enable_leaderboard)}
            />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="space-y-2">
