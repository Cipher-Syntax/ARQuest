      ...
      <Card>
        ...
        <div className="space-y-5">
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">App Name</label>
            <input
              type="text"
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm font-bold text-gray-900 text-red-600">Maintenance Mode</p>
              <p className="text-xs text-gray-500 mt-0.5">Disable access to the mobile app for maintenance.</p>
            </div>
            <Toggle checked={settings.maintenance_mode} onChange={() => handleChange('maintenance_mode', !settings.maintenance_mode)} />
          </div>
        </div>
      </Card>
      ...
      <Card>
        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between gap-4">
            ...
            <Toggle checked={settings.enable_gps} onChange={() => handleChange('enable_gps', !settings.enable_gps)} />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="flex items-start justify-between gap-4">
            <div>
            ...
            <Toggle checked={settings.enable_qr} onChange={() => handleChange('enable_qr', !settings.enable_qr)} />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="flex items-start justify-between gap-4">
            <div>
            ...
            <Toggle checked={settings.enable_ar_selfie} onChange={() => handleChange('enable_ar_selfie', !settings.enable_ar_selfie)} />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="flex items-start justify-between gap-4">
            <div>
            ...
            <Toggle checked={settings.enable_accreditation} onChange={() => handleChange('enable_accreditation', !settings.enable_accreditation)} />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="flex items-start justify-between gap-4">
            <div>
            ...
            <Toggle checked={settings.enable_trivia} onChange={() => handleChange('enable_trivia', !settings.enable_trivia)} />
          </div>
        </div>
      </Card>
        ...
        <div className="space-y-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Enable student rankings and XP scoring.</p>
            </div>
            <Toggle checked={settings.enable_leaderboard} onChange={() => handleChange('enable_leaderboard', !settings.enable_leaderboard)} />
          </div>
          <div className="h-px bg-brand-border" />
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Default Quest Reward (XP)</label>
            <input
              type="number"
              value={settings.default_quest_reward}
              onChange={(e) => handleChange('default_quest_reward', parseInt(e.target.value) || 0)}
