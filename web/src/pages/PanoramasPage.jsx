...
const PanoramasPage = () => {
  ...
  return (
    <div>
      ...
      >
        <div>
          <h1 style={{ fontSize: '28px', fontWeight: 'bold', margin: 0 }}>Panorama Management</h1>
      ...
      >
        {buildings.map((building) => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'start', gap: theme.spacing.md }}>
              <div
                style={{
                  width: '48px',
                  height: '48px',
              ...
              <div style={{ flex: 1 }}>
                <h3 style={{ fontSize: '18px', fontWeight: '600', margin: 0 }}>{building.name}</h3>
                <p
                  style={{ fontSize: '14px', color: theme.colors.text.secondary, marginTop: '4px' }}
                >
      ...
      {buildings.length === 0 && (
        <div style={{ textAlign: 'center', padding: '48px', color: theme.colors.text.secondary }}>
