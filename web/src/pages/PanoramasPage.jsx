		...
		<div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
				{buildings.map((building) => {
					const hasPanoramas = building.scenes && building.scenes.length > 0;
					...
					return (
						...
						>
							<div className="aspect-video bg-gray-100 rounded-lg mb-4 flex items-center justify-center relative overflow-hidden">
								{hasPanoramas ? (
									<div className="w-full h-full">
										<img
											src={getFullUrl(building.scenes[0].image_url)}
											alt={building.name}
							...
							<div>
								<h3 className="font-bold text-gray-900 truncate">{building.name}</h3>
