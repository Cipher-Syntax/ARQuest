...
const DragDropFileUpload = ({ accept, onChange, value, placeholder = "Drag & drop file here or click to browse" }) => {
    ...
    return (
        ...
        >
            ...
            {value ? (
                ...
                <>
                    <Upload size={32} color={theme.colors.text.secondary} style={{ margin: '0 auto 8px' }} />
                    <div style={{ fontSize: '14px', color: theme.colors.text.secondary }}>{placeholder}</div>
