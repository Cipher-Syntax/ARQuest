      ...
      <div className="space-y-5 max-h-[70vh] overflow-y-auto scrollbar-thin pr-2">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Category / Department</label>
            <select
        ...
        <div className="pt-6 border-t border-brand-border">
          <p className="text-[10px] font-black text-brand uppercase tracking-[0.2em] mb-4">Content & Media (Partial Upload)</p>
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-brand-border rounded-lg p-8 flex flex-col items-center justify-center gap-2 bg-brand-light/20 hover:bg-brand-light/40 transition-all cursor-pointer group">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase group-hover:text-brand transition-colors">Select GLB File</p>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-brand-border rounded-lg p-8 flex flex-col items-center justify-center gap-2 bg-brand-light/20 hover:bg-brand-light/40 transition-all cursor-pointer group">
                ...
                <p className="text-[10px] font-bold text-gray-400 uppercase group-hover:text-brand transition-colors">Select Image</p>
              </div>
            </div>
          </div>
        </div>
