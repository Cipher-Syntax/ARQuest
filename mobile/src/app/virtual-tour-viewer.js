...
export default function VirtualTourViewerScreen() {
	const { buildingId, buildingName, buildingDescription, modelUrl, hotspots, controlMode } = useLocalSearchParams();
		...
		<View style={styles.container}>
			...
			<View style={styles.hudTopContainer} pointerEvents="none">
				...
				<Text style={styles.hudSubtitle}>
					{controlMode === 'gyroscope' ? 'GYROSCOPE MODE ACTIVE' : 'VIRTUAL TOUR ACTIVE'}
				</Text>
			</View>
