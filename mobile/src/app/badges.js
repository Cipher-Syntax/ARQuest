            ...
            >
                <View
                    style={[
                        ...
                        { borderColor: earned ? item.color_hex : "#444" },
                    ]}
                >
                    <Text
                        style={[styles.badgeEmoji, !earned && { opacity: 0.3 }]}
                    >
                        {item.icon}
                    </Text>
                    {earned && (
                            ...
                            {selected.earned && (
                                <View
                                    style={[
                                        ...
                                        {
                                            backgroundColor: `${selected.color_hex}22`,
                                            borderColor: selected.color_hex,
                                        },
                                    ]}
                                >
                                    <Text
                                        style={[
                                            styles.earnedPillText,
