    ...
    <script>
        ...
        function processUpdateMap(data) {
            ...
            buildings.forEach(b => {
                ...
                } else if (isUnlocked && b.model_active && b.model_url) {
                    iconHtml = \`
                    <div style="display: flex; flex-direction: column; align-items: center;">
                        <div style="width: 80px; height: 80px; position: relative; margin-bottom: -10px;">
                            <model-viewer
                                src="\${b.model_url}"
                                auto-rotate
                        ...
                        <div style="width: 16px; height: 16px; background-color: \${iconColor}; border-radius: 50%; border: 2px solid white; box-shadow: 0 0 4px rgba(0,0,0,0.4); z-index: 2;"></div>
                    </div>\`;
                } else {
                    iconHtml = \`
