...
urlpatterns = [
	...
	path('challenges/', gamification_views.ChallengesView.as_view(), name='challenges'),
	path('quests/active/', gamification_views.ActiveQuestsView.as_view(), name='active-quests'),
	path('quests/<uuid:pk>/complete/', gamification_views.CompleteQuestView.as_view(), name='complete-quest'),
